# As-Built Baseline v0.2.25-LMSTUDIO

This is the authoritative cumulative baseline for the v0.2.25 package. All prior implemented changes remain in scope unless explicitly superseded in CHANGELOG.md.
