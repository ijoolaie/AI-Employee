...
## v0.2.19 follow-up hardening (planned in this baseline)

The next security increment is granular tool authorization and approval enforcement. Tool policy fields are introduced before any external or side-effecting tools are added.
