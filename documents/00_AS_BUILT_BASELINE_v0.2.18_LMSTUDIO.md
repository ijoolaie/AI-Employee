# AI Employee Platform — As-Built Baseline v0.2.18 (LM Studio)

**Date:** 2026-08-07  
**Baseline policy:** cumulative; this release carries forward all implemented v0.2.7–v0.2.15 changes plus the v0.2.18 Usage/Cost reporting surface.
...
- **v0.2.18:** tenant-scoped read-only Usage/Cost summary API and Customer Usage page.

## v0.2.18 Usage surface
...
## v0.2.18 Tool Registry addendum

See `28_TOOL_REGISTRY_EXECUTION_AS_BUILT_v0.2.18.md` for the authoritative Tool Registry and controlled execution details.
