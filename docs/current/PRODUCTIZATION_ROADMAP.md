...
The merged implementation adds a deterministic recursive redaction boundary for common credentials, tokens, connection strings and direct PII in structured audit metadata and JSON logs, with unit regression coverage. Threat-model, privacy/retention, compliance-control and pentest-ready preparation is captured in `docs/current/PHASE_14_14_SECURITY_PRIVACY_COMPLIANCE.md`. Security artifact: `phase-14-14-security-27e19b67ac58776796b3f3db89dd402cbc958a45` (SHA256 `209a4b4a4249cd7c26cf17f83eb77a9b59de012416a2053632d7a5bc19844696`).
