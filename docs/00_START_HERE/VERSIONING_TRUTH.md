...
Current `main` is post-certification engineering/documentation work and resolves to `f83dcc5d16d299d28aa07f27949782130489833e`. It contains subsequent changes and is therefore outside the certified `v1.4.11` snapshot. A new application-code release candidate must receive fresh exact-SHA certification.
