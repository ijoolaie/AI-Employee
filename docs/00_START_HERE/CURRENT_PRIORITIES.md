...
Phase 13 and Phase 14.1–14.13 engineering are complete. The remaining work is intentionally sequenced so that **External Production Certification & Customer Acceptance is the final stage**.
...
CI and local/rehearsal evidence cannot substitute for independent external evidence.

## Evidence rules

- CI/internal load validation = engineering evidence.
