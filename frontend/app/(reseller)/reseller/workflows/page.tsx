  ...
  return <>
    ...
    <div className="space-y-4 p-6 pt-0">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <Link href="/workflows" className="inline-flex items-center gap-2 rounded-md border px-3 py-2 text-sm font-medium hover:bg-gray-50"><ExternalLink className="h-4 w-4" />{m.manage}</Link>
      </div>
