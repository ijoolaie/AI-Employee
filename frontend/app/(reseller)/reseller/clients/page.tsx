...
export default function ResellerClientsPage() {
  ...
  const deprovision = useMutation({ mutationFn: (id: string) => api.post("/edition/reseller/customers/" + id + "/deprovision"), onSuccess: () => qc.invalidateQueries({ queryKey: ["reseller-clients"] }) });
