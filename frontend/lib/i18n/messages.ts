...
const employee = {
  ...
  copyEmbed: "Embed on a website with", templates: "Employee Templates", templatesDescription: "Start from a curated AI employee template.", existingChannels: "Published channels", retry: "Retry", guardrailsLoadError: "Unable to load guardrails.", guardrailsSaveError: "Unable to save guardrails.", publishError: "Unable to publish channel.", publishSuccess: "Channel published successfully.", runLoadError: "Unable to load run history.", runError: "Unable to start run.", details: "Details", status: "Status", tokens: "Tokens", cost: "Cost", id: "ID", active: "Active", inactive: "Inactive", slugKind: "Slug / kind", guardrailsInvalid: "Guardrails must be valid JSON.", notFound: "Employee not found.", first: "first."
} as const;
...
const customerLegacy = {
  ...
  marketplace:{title:"Marketplace",description:"Discover published teams and install tenant-local copies.",boundary:"Authorized installation boundary",boundaryText:"Marketplace installation is permission-gated by the API and creates tenant-local definitions with publication provenance.",target:"Target workspace",workspacePlaceholder:"default workspace",workspaceNote:"The workspace key is tenant-local and is passed unchanged to the installation boundary.",published:"Published teams",noPublished:"No published teams",noPublishedDescription:"No public marketplace publications are currently available to this tenant.",review:"Review & install",reviewTitle:"Installation review",install:"Install",installing:"Installing…",installed:"Installation completed.",localOnly:"Installation creates a tenant-local copy.",loadError:"Unable to load marketplace publications.",retry:"Retry"},
  onboarding:{title:"Get your business live",description:"A guided setup from signup to a working AI Employee.",checklist:"Launch checklist",checklistDescription:"Complete the six steps once. You can return to any setup area later.",business:"Business",businessDesc:"Tell us what you sell.",brand:"Brand",brandDesc:"Set your store identity and tone.",products:"Products",productsDesc:"Add products or connect Shopify for live catalog and inventory.",employee:"Employee",employeeDesc:"Choose tools such as product search, inventory and order tracking.",channel:"Channel",channelDesc:"Publish website chat, WhatsApp or a public link.",launch:"Launch",launchDesc:"Run a live customer conversation and verify the commerce loop.",complete:"Complete step",completed:"Completed — mark again",connectShopify:"Connect Shopify",chooseTemplate:"Choose Template",configureEmployee:"Configure Employee",manageChannels:"Manage Channels",openInbox:"Open Inbox",viewRoi:"View ROI",ready:"Your business is ready to launch.",readyDescription:"Publish an Employee and connect a customer channel.",loadError:"Unable to load onboarding.",retry:"Retry"},
