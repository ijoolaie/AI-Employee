...
const customersFa = {
  title: "مشتریان", description: "پروفایل مشتریانی که به کارمندان هوش مصنوعی و کانال‌های شما متصل هستند.", create: "افزودن مشتری", createTitle: "ایجاد مشتری", searchPlaceholder: "جستجو بر اساس نام، ایمیل یا شماره تلفن…", directory: "فهرست مشتریان", anonymous: "مشتری ناشناس", empty: "هنوز مشتری‌ای وجود ندارد. مشتریان با شروع گفتگو به‌صورت خودکار ایجاد می‌شوند.", edit: "ویرایش", editTitle: "ویرایش مشتری", name: "نام", email: "ایمیل", phone: "تلفن", notes: "یادداشت", tags: "برچسب‌ها", save: "ذخیره تغییرات", cancel: "لغو", active: "فعال", inactive: "غیرفعال", status: "وضعیت", updateError: "به‌روزرسانی مشتری انجام نشد.", createError: "ایجاد مشتری انجام نشد.", permissionDenied: "شما اجازه مدیریت مشتریان را ندارید.", retry: "تلاش مجدد",
} as const;
...
const publicChat = { loading:"Loading assistant…", unavailable:"This assistant link is not available.", greeting:"Hi! How can I help?", greetingDescription:"Ask about products, sizes, availability, orders, or anything this store has configured me to help with.", start:"Start chat", placeholder:"Type your question…", startFirst:"Start the chat first" } as const;
const publicChatFa = { loading:"در حال بارگذاری دستیار…", unavailable:"این لینک دستیار در دسترس نیست.", greeting:"سلام! چطور می‌توانم کمک کنم؟", greetingDescription:"درباره محصولات، اندازه‌ها، موجودی، سفارش‌ها یا هر چیزی که این فروشگاه برای کمک پیکربندی کرده است سؤال کنید.", start:"شروع گفتگو", placeholder:"سؤال خود را بنویسید…", startFirst:"ابتدا گفتگو را شروع کنید" } as const;
