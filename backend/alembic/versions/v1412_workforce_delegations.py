...
Revises: customerproductlifecycle01
"""
...
down_revision = "customerproductlifecycle01"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_workforce_delegations_tenant_status",
        "workforce_delegations",
        ["tenant_id", "status"],
    )
    op.create_index(
        "ix_workforce_delegations_manager",
        "workforce_delegations",
        ["tenant_id", "manager_agent_instance_id"],
    )
