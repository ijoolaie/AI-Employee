...
def upgrade() -> None:
    ...
    op.create_index("ix_parallel_branch_lease_expires_at", "workflow_parallel_branch_runs", ["execution_lease_expires_at"])


def downgrade() -> None:
    op.drop_index("ix_parallel_branch_lease_expires_at", table_name="workflow_parallel_branch_runs")
