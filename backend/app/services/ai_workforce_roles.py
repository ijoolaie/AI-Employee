...
WORKFORCE_ROLES: tuple[WorkforceRole, ...] = (
    WorkforceRole(
        ...
        capability_contract=_contracts(
            ...
            {"request_workforce_capacity": ("workforce_request_capacity",), "prepare_ceo_report": ("workforce_prepare_ceo_report",), "prepare_cost_optimization": ("workforce_prepare_cost_optimization",)},
        ),
    ),
    WorkforceRole(
