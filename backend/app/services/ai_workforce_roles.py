...
WORKFORCE_ROLES: tuple[WorkforceRole, ...] = (
    WorkforceRole(
        ...
        capability_contract=_contracts(
            ...
            {"assign_task": ("workforce_assign_task",), "reprioritize_task": ("workforce_reprioritize_task",), "coordinate_handoff": ("workforce_coordinate_handoff",), "balance_workload": ("workforce_balance_workload",), "request_workforce_capacity": ("workforce_request_capacity",), "prepare_ceo_report": ("workforce_prepare_ceo_report",), "prepare_budget_estimate": ("workforce_prepare_budget_estimate",), "prepare_cost_optimization": ("workforce_prepare_cost_optimization",)},
        ),
    ),
    WorkforceRole(
        ...
        capability_contract=_contracts(["draft_campaign_plan","coordinate_content","analyze_campaign_performance","prepare_growth_report"], ["paid_campaign_launch","material_ad_spend","contractual_commitment","external_purchase"], {"draft_campaign_plan": ("workforce_draft_campaign_plan",), "coordinate_content": ("workforce_coordinate_content",), "prepare_growth_report": ("workforce_prepare_growth_report",)}),
    ),
    WorkforceRole(
