...
class CommercialLicense(Base):
    ...
    feature_codes: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    license_metadata: Mapped[dict] = mapped_column("metadata", JSON, nullable=False, default=dict)
