...
from app.core.deps import DbSession, InvoiceCreateContext, InvoiceExportPdfContext, InvoiceReadContext, InvoiceUpdateContext
...
async def invoice_summary(ctx: InvoiceReadContext, db: DbSession):
...
async def get_invoice(invoice_id: UUID, ctx: InvoiceReadContext, db: DbSession):
...
async def export_pdf(invoice_id: UUID, ctx: InvoiceExportPdfContext, db: DbSession):
